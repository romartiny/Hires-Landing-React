    ...
    return (
        <header id="hires-header" className='fixed w-full z-10'>
            <Container className={'flex justify-between p-5'}>
                ...
                <button className="hidden lg:block bg-white rounded-3xl px-6 py-2.5 border-2 border-white text-black hover:bg-transparent hover:text-white hover:border-2 transition duration-300">Забронировать</button>
